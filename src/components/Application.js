          ...
          <div className="row">
            ...
            <div className="col-md-8">
              ...
              <form action="https://formspree.io/isabellemajerus54@gmail.com" method="POST">
                ...
                <div className="input-pair">
                  <input className="select input-pair-checkbox" type="checkbox" name="best_time" value="afternoons" />
                  <label htmlFor="best_time">Afternoons</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-checkbox" type="checkbox" name="best_time" value="evenings" />
                ...
                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="puppy_gender_preference" value="male" />
                  <label htmlFor="puppy_gender_preference">Male</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="puppy_gender_preference" value="female" />
                  <label htmlFor="puppy_gender_preference">Female</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="puppy_gender_preference" value="no preference" />
                ...
                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="neuter_or_spay" value="yes" />
                  <label htmlFor="neuter_or_spay">Yes</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="neuter_or_spay" value="no" />
                  <label htmlFor="neuter_or_spay">No</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="neuter_or_spay" value="unsure" />
                  <label htmlFor="neuter_or_spay">Unsure</label>
                </div>

                <p className="survey-question">Do you hope to breed your dog?</p>
                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="plan_to_breed" value="yes" />
                  <label htmlFor="plan_to_breed">Yes</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="plan_to_breed" value="no" />
                  <label htmlFor="plan_to_breed">No</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="plan_to_breed" value="unsure" />
                ...
                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="whelped_litter_or_owned_stud" value="yes" />
                  <label htmlFor="whelped_litter_or_owned_stud">Yes</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="whelped_litter_or_owned_stud" value="no" />
                  <label htmlFor="whelped_litter_or_owned_stud">No</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="whelped_litter_or_owned_stud" value="I do not plan to breed ny dog." />
                ...
                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="willing_to_screen_health" value="yes" />
                  <label htmlFor="willing_to_screen_health">Yes</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="willing_to_screen_health" value="no" />
                  <label htmlFor="willing_to_screen_health">No</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="willing_to_screen_health" value="I do not plan to breed my dog." />
                ...
                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="owned_dog_before" value="yes" />
                  <label htmlFor="owned_dog_before">Yes</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="owned_dog_before" value="no" />
                ...
                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="how_often_travel" value="weekly" />
                  <label htmlFor="how_often_travel">Weekly</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="how_often_travel" value="once to twice per month" />
                  <label htmlFor="how_often_travel">Once to twice per month</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="how_often_travel" value="every 3 to 6 months" />
                  <label htmlFor="how_often_travel">Every three to six months</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="how_often_travel" value="once or twice per year" />
                  <label htmlFor="how_often_travel">Once or twice per year</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="how_often_travel" value="almost never" />
                ...
                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="will_attend_obedience_with_puppy" value="yes" />
                  <label htmlFor="will_attend_obedience_with_puppy">Yes</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="will_attend_obedience_with_puppy" value="no" />
                  <label htmlFor="will_attend_obedience_with_puppy">No</label>
                </div>

                <div className="input-pair">
                  <input className="select input-pair-radio" type="radio" required name="will_attend_obedience_with_puppy" value="unsure" />
