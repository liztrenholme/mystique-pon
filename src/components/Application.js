                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <form action="https://formspree.io/liztrenholme@gmail.com" method="POST">
                                ...
                                <input className="select" type="checkbox" required name="best_time" value="mornings" />
                                <label htmlFor="best_time">Mornings</label>

                                <input className="select" type="checkbox" required name="best_time" value="afternoons" />
                                <label htmlFor="best_time">Afternoons</label>

                                <input className="select" type="checkbox" required name="best_time" value="evenings" />
                                ...
                                <textarea className="text-input" required rows="10" cols="40" name="experience_breeding" width="50%" height="50%"></textarea>
                                ...
                                <textarea className="text-input" required rows="10" cols="40" name="what_breed" width="50%" height="50%"></textarea>
                                ...
                                <textarea className="text-input" required rows="10" cols="40" name="any_questions" width="50%" height="50%"></textarea>
